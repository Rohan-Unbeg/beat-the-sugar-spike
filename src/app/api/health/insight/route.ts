...
export async function POST(req: Request) {
  try {
    ...
    // Basic input sanitization for any text fields if they existed, but here we have numbers/booleans mostly.
    // If we add a 'question' field later, we should sanitize it.
        ...
        try {
           ...
           if (jsonStr) {
             try {
               ...
               console.warn("Invalid Gemini insight JSON:", jsonStr);
             }
           }
        } catch (e) {
          ...
          try {
            ...
            if (content) {
              try {
                ...
                console.warn("Invalid Groq insight JSON:", content);
              }
            }
          } catch (error: any) {
